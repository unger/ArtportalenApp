...
set platform=iOS
for /f "delims=" %%i in ('..\_tools\VersionBumper.exe ios "C:\Projects\GitHub\ArtportalenApp\ArtportalenApp\ArtportalenApp.iOS\Info.plist"') do set BuildVersion=%%i

call _include.cmd


%MSBuildCustomPath% ..\ArtportalenApp\ArtportalenApp.iOS\ArtportalenApp.iOS.csproj /fl /flp:logfile="%MsBuildLogFile%" /t:Clean,Build /p:Configuration=Ad-Hoc;Platform=iPhone;ServerAddress=10.112.0.125;ServerUser=Layer10;OutputPath=%tempFolderAbsolute%
